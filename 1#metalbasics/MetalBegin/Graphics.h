...
{
    GX_TEX_ADDRESS_MODE     AddressU;
    GX_TEX_ADDRESS_MODE     AddressV;
    
    GX_TEX_FILTER   MinFilter;
    GX_TEX_FILTER   MagFilter;
};
...
GX_UINT32 BytesForPixelFormat(GX_PIXEL_FORMAT _fmt)
{
    switch (_fmt)
    {
...
struct GX_EFFECT_DESC
{
    ...
    const GXRenderState *       pRenderState;
...
struct IGXDevice
{
    ...
    virtual IGXTex * CreateTextureDyn(GX_PIXEL_FORMAT _fmt, GX_VOID * _pData,GX_UINT32 _nWidth,GX_UINT32 _nHeight) = 0;
    ...
    virtual GX_BOOL DrawIndexed( GX_DRAW _drawMode, IGXIB * _pIB, GX_UINT32 _NumVertices, GX_UINT32  _NumInstance );
    ...
    virtual GXRenderState * GetCurrentRenderState() = 0;
